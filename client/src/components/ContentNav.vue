<template>
  <div>
    ...
    <!-- <label for="shadow">
      <span class="circle"></span><span>Realistic</span></label
    > -->
    <div class="folder">
      <div class="tabs">
        <button
        ...
        <div class="content__inner" id="tab-1">
          <div class="page">
            <p>
              ...
              performance keywords market-facing drink from the firehose, or you
              better eat a reality sandwich before you walk back in that
